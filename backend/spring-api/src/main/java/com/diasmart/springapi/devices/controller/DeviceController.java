...
public class DeviceController {
    ...
    @GetMapping
    public ResponseEntity<ApiResponse<List<DeviceSummaryDTO>>>
    getAllDevices() {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<ApiResponse<DeviceResponseDTO>>
    getDeviceById(
    ...
    public ResponseEntity<ApiResponse<DeviceDiagnosticsDTO>>
