      ...
      <Grid container spacing={2}>
        <Grid size={{ xs: 12, md: 6 }}>
          <TextField
            ...
            helperText="TODO: Implement search filter logic"
          />
        </Grid>
        ...
        <Grid size={{ xs: 12, sm: 6, md: 3 }}>
          <TextField
            ...
            value=""
            helperText="TODO: Implement status filter logic"
          />
        </Grid>
        ...
        <Grid size={{ xs: 12, sm: 6, md: 3 }}>
          <TextField
            ...
            fullWidth
            disabled
            label="Filter by Glucose"
            value=""
            helperText="TODO: Implement glucose filter logic"
          />
        </Grid>
      </Grid>
    </Box>
