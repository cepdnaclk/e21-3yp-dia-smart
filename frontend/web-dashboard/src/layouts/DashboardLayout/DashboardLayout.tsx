    ...
    <Box sx={layoutStyles}>
      ...
      <Box
        ...
        sx={{
          ...
          minWidth: 0,
          pb: isMobile ? "calc(160px + env(safe-area-inset-bottom, 0px))" : "24px", // adds buffer at the bottom for bottom navigation on mobile with safe area support
      ...
      >
        <Toolbar sx={{ pt: "env(safe-area-inset-top, 0px)", mb: { xs: 2, sm: 0 } }} />
