...
public class AuditService {
        ...
        public static final String NOTIFICATION_PREFERENCES_UPDATED = "NOTIFICATION_PREFERENCES_UPDATED";
        public static final String FAILED_PAYLOAD_VALIDATION = "FAILED_PAYLOAD_VALIDATION";
        ...
        public void logDeviceUnassignment(
                        Device device,
                        Long previousPatientId) {
                Map<String, Object> details = new LinkedHashMap<>();
                details.put("deviceUid", device.getDeviceUid());
