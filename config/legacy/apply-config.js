...
const mqttUrl = new URL(mqtt.brokerUrl);
const mqttPort = mqttUrl.port ? Number(mqttUrl.port) : (mqttUrl.protocol === 'mqtts:' ? 8883 : 1883);
const backendMqttUrl = String(mqtt.backendBrokerUrl || mqtt.brokerUrl).trim();
...
MQTT_BROKER_URL=${backendMqttUrl}
...
#define MQTT_ENABLED ${mqtt.enabled ? 1 : 0}
#define MQTT_BROKER_HOST \"${mqttUrl.hostname}\"
#define MQTT_BROKER_PORT ${mqttPort}
#define MQTT_USERNAME \"${mqtt.username}\"
#define MQTT_PASSWORD \"${mqtt.password}\"
#define MQTT_CLIENT_ID \"${mqtt.clientId}\"
#define MQTT_TOPIC_PREFIX \"${mqtt.topicPrefix}\"
